<template>
  <div style="background: #f6f5f7;">
    ...
    <div style="margin-left:50px; margin-right: 50px; ">
      <el-row :gutter="50">
        <el-col style="margin-top:15px;" :span="2.1">
          <el-button
            style="width: 80px; height: 80px"
            type="info"
            circle
            @click.native.prevent="onClicktag(1)"
          >
            <i style="font-size: 40px" class="el-icon-video-camera-solid"></i>
          </el-button>
          <div style="font: 20px roboto,arial,sans-serif;">Tech</div>
        </el-col>
        <el-col style="margin-top:15px;" :span="2.1">
          <el-button
            style="width: 80px; height: 80px"
            type="info"
            circle
            @click.native.prevent="onClicktag(2)"
          >
            <i style="font-size: 40px" class="el-icon-headset"></i>
          </el-button>
          <div style="font: 20px roboto,arial,sans-serif;">Life</div>
        </el-col>
        <el-col style="margin-top:15px;" :span="2.1">
          <el-button
            style="width: 80px; height: 80px"
            type="info"
            circle
            @click.native.prevent="onClicktag(3)"
          >
            <i style="font-size: 40px" class="el-icon-basketball"></i>
          </el-button>
          <div style="font: 20px roboto,arial,sans-serif;">Anime</div>
        </el-col>
      </el-row>
    </div>
    <div style="margin-left:75px; margin-right: 150px;">
